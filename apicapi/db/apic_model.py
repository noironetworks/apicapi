...
from apicapi.db import api as db_api
from apicapi.db import model_base
...
class RouterContract(model_base.BASE, HasTenant):
...
class HostLink(model_base.BASE):
...
class ApicName(model_base.BASE):
