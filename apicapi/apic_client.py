...
class ManagedObjectClass(object):
    ...
    supported_mos = {
        ...
        'fvTenant': ManagedObjectName('polUni', 'tn-%(name)s',
                                      name_fmt='__%s'),
        'qosRequirement': ManagedObjectName('fvTenant',
                                            'qosreq-%(name)s',
                                            name_fmt='%s'),
        'qosRsIngressDppPol': ManagedObjectName('qosRequirement',
                                                'rsingressDppPol'),
        'qosRsEgressDppPol': ManagedObjectName('qosRequirement',
                                               'rsegressDppPol'),
        'qosEpDscpMarking': ManagedObjectName('qosRequirement',
                                              'dscpmarking'),
        'qosDppPol': ManagedObjectName('fvTenant',
                                       'qosdpppol-%(name)s',
                                       name_fmt='%s'),
        'fvRsQosRequirement': ManagedObjectName('fvAEPg', 'rsqosRequirement'),
        ...
        'vzOOBBrCP': ManagedObjectName('fvTenant', 'oobbrc-%s'),
        'vzBrCP': ManagedObjectName('fvTenant', 'brc-%s'),
        'vzSubj': ManagedObjectName('vzBrCP', 'subj-%s'),
        'vzSubj__tn': ManagedObjectName('vzOOBBrCP', 'subj-%s'),
        ...
        'hostprotRemoteIpContainer': ManagedObjectName('hostprotPol',
                                                       'remoteipcont'),
        'hostprotRemoteIp__cont': ManagedObjectName(
        ...
        ManagedObjectName('vmmVSwitchPolicyCont', 'rsvswitchExporterPol-[%s]'),
